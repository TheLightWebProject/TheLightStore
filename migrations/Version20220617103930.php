 ...
 */
final class Version20220617103930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE delivery_date delivery_date DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE delivery_date delivery_date DATETIME DEFAULT NULL');
    }
}
